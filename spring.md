...
public void test3(){
    ApplicationContext context = new ClassPathXmlApplicationContext("bean1.xml");
    User user_constructor = context.getBean("User_constructor", User.class);
...
<!--Druid-->
    ...
    <!--1.更改命名空间-->
<!--    2.引入外部属性文件-->
    <context:property-placeholder location="classpath:classpath:resource/properties/jdbc.properties"/>
<!--    3.配置连接池-->
