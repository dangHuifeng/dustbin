...
![image-20220515155301769](C:\Users\lenvoo\AppData\Roaming\Typora\typora-user-images\image-20220515155301769.png)
...
![image-20220515155949025](C:\Users\lenvoo\AppData\Roaming\Typora\typora-user-images\image-20220515155949025.png)
...
```xml
  <groupId>com.dhf.maven</groupId>
  <artifactId>dhf-maven-java</artifactId>
  <version>1.0-SNAPSHOT</version>
```
...
```log
D:\maven-repo\com\dhf\maven\dhf-maven-java\1.0-SNAPSHOT\dhf-maven-java-1.0-SNAPSHOT.jar
```
...
<!-- 如果不省略version，相当于子工程的依赖覆盖父工程的依赖-->
<dependencies>
	<dependency>
		<groupId>org.springframework</groupId>
		<artifactId>spring-core</artifactId>
